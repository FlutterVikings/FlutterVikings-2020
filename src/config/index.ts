export default {
  ...
  siteDescription:
    'FlutterVikings is a single track Flutter/Dart conference with talks by internationally renowned speakers and rising stars in the Flutter/Dart community', // Your site description
